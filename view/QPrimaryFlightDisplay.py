...
class QPrimaryFlightDisplay(QOpenGLWidget):
    ...
    def update_style(self, palette=None):
        ...
        self.hg2.setJoinStyle(Qt.PenJoinStyle.RoundJoin)
        self.hg2.setCapStyle(Qt.PenCapStyle.RoundCap)
        ...
        self.wrn3.setJoinStyle(Qt.PenJoinStyle.RoundJoin)
        self.wrn3.setCapStyle(Qt.PenCapStyle.RoundCap)
        self.err = QColor(0xda, 0x44, 0x53, 0xff)
        self.err3 = QPen(self.err, 3 * s)
        self.err3.setJoinStyle(Qt.PenJoinStyle.RoundJoin)
        self.err3.setCapStyle(Qt.PenCapStyle.RoundCap)
        self.pst = QColor(0x27, 0xae, 0x60)
        self.sky = palette.color(QPalette.ColorRole.Base)
        self.ground = palette.color(QPalette.ColorRole.Window)
    ...
    def paintEvent(self, e):
        ...
        self.painter.setRenderHints(QPainter.RenderHint.TextAntialiasing)
    ...
    def draw_status(self):
        ...
        if self.battery is not None:
            ...
            painter.drawText(rect, Qt.AlignmentFlag.AlignCenter, f"{round(self.battery)}%")
